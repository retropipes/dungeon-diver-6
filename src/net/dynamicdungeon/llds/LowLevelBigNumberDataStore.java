...
public final class LowLevelBigNumberDataStore implements Cloneable {
    // Fields
    ...
    // Constructor
    public LowLevelBigNumberDataStore(final int... shape) {
    ...
    @Override
    public Object clone() {
	final LowLevelBigNumberDataStore copy = new LowLevelBigNumberDataStore(this.dataShape);

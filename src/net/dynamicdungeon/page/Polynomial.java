...
public class Polynomial {
    ...
    public static Polynomial readPolynomial(final DatabaseReader reader) throws IOException {
    ...
    public void writePolynomial(final DatabaseWriter writer) throws IOException {

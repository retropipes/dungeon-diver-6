package net.dynamicdungeon.page;
...
public final class Page extends Polynomial {
    ...
    public Page(final int maxPower, final int params, final int range, final boolean isExperience) {
    ...
    public static Page readPage(final DatabaseReader reader) throws IOException {
    ...
    public void writePage(final DatabaseWriter writer) throws IOException {

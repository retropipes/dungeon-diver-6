...
public class DynamicProperties {
	...
	if (cache == null) {
	    cache = DynamicProperties.getLibraryFallbackDirectory() + File.separator
		    + DynamicProperties.CACHES_FALLBACK_DIR;
	}
	return cache;
    }
	...
	if (appsupport == null) {
	    appsupport = DynamicProperties.getLibraryFallbackDirectory() + File.separator

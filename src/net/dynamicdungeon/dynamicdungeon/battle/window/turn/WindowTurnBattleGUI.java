...
import net.dynamicdungeon.dynamicdungeon.battle.BossRewards;
...
public class WindowTurnBattleGUI {
	...
	public void actionPerformed(final ActionEvent e) {
		...
		final AbstractBattle b = DynamicDungeon.getApplication().getBattle();
		// Clear Message Area
		...
		if (cmd.equals("Attack") || cmd.equals("a")) {
		    ...
		    // Cast Spell
		    success = b.doPlayerActions(AbstractWindowAIRoutine.ACTION_CAST_SPELL);
		    if (!success) {

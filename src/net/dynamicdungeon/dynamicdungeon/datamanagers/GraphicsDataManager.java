...
public class GraphicsDataManager {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(GraphicsDataManager.class
		.getResourceAsStream("/net/dynamicdungeon/dynamicdungeon/resources/data/graphics/objects.txt"))) {
	    // Fetch data
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(GraphicsDataManager.class
		.getResourceAsStream("/net/dynamicdungeon/dynamicdungeon/resources/data/graphics/stats.txt"))) {
	    // Fetch data
	    final ArrayList<String> rawData = new ArrayList<>();
	    String line = "";
	    while (line != null) {

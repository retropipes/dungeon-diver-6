...
public class PartyManager {
    ...
    public static void loadGameHook(final DatabaseReader partyFile) throws IOException {
    ...
    public static void saveGameHook(final DatabaseWriter partyFile) throws IOException {
    ...
    public static PartyMember getNewPCInstance(final int r, final int c, final String n) {

 ...
 */
package net.dynamicdungeon.dynamicdungeon.creatures.races;

import java.io.IOException;
import java.util.ArrayList;

import net.dynamicdungeon.dynamicdungeon.DynamicDungeon;
import net.dynamicdungeon.dynamicdungeon.datamanagers.RaceDataManager;
...
public class RaceConstants {
	...
	if (!RaceConstants.INITED) {
	    try (final ResourceStreamReader rsr = new ResourceStreamReader(RaceDataManager.class
		    .getResourceAsStream("/net/dynamicdungeon/dynamicdungeon/resources/data/race/catalog.txt"))) {
		// Fetch data

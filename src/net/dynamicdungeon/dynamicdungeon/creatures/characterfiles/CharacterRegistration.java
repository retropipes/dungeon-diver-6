...
public class CharacterRegistration {
    ...
    private static final String CHARACTER_DIR = "/DDNet/DynamicDungeon/Characters";
	...
	if (characterNames != null && characterNames.length > 0) {
	    // Strip extension
	    final int stripCount = Extension.getCharacterExtensionWithPeriod().length();
	...
	return CharacterRegistration.CHARACTER_DIR;
    }

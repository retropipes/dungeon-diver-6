...
public class ItemInventory {
    ...
    public void equipWeapon(final AbstractCreature pc, final Equipment ei, final boolean playSound) {
    ...
    public static ItemInventory readItemInventory(final DatabaseReader dr) throws IOException {

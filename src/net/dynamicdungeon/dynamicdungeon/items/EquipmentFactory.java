...
public class EquipmentFactory {
    ...
    // Methods
    public static Equipment createWeapon(final int material, final int weaponType, final int bonus) {
	final Equipment e = new Equipment(
		...
		0, 0, EquipmentCategoryConstants.EQUIPMENT_CATEGORY_WEAPON, material);
	...
	for (int x = 0; x < res.length; x++) {
	    res[x] = WeaponMaterialConstants.MATERIAL_COMMON_NAMES[x] + " " + WeaponConstants.getWeapons()[weaponType];
	}
	return res;
    }

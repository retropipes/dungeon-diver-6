...
class StatGUI {
	...
	if (party != null) {
		...
		this.powerLabel.setText(DynamicDungeon.getApplication().getGameManager().getPowerString());
	...
	final BufferedImageIcon powerImage = StatImageManager.getImage(StatImageConstants.STAT_IMAGE_POWER);

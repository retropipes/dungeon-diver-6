...
public class FileHooks {
    ...
    public static void loadGameHook(final DatabaseReader mapFile) throws IOException {
	PartyManager.loadGameHook(mapFile);
    }

    public static void saveGameHook(final DatabaseWriter mapFile) throws IOException {

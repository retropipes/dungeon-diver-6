...
public class GameLoadTask extends Thread {
	...
	try {
	    ...
	    DynamicDungeon.getApplication().getDungeonManager().handleDeferredSuccess(false, true, mazeFile);
	} catch (final FileNotFoundException fnfe) {
	    CommonDialogs.showDialog("Loading the " + sg.toLowerCase()
		    + " failed, probably due to illegal characters in the file name.");
	    DynamicDungeon.getApplication().getDungeonManager().handleDeferredSuccess(false, false, null);

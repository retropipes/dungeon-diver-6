...
public class UTurnTrap extends AbstractTrap {
	...
	DynamicDungeon.getApplication().showMessage("Your controls are turned around!");
	DynamicDungeon.getApplication().getGameManager().activateEffect(DungeonEffectConstants.EFFECT_U_TURNED);

...
public class EmptyVoid extends AbstractWall {
	...
	final AbstractDungeonObject mo1 = app.getDungeonManager().getDungeonObject(x - 1, y - 1, z,
	...
	final AbstractDungeonObject mo2 = app.getDungeonManager().getDungeonObject(x - 1, y, z,
		DungeonConstants.LAYER_OBJECT);
	try {
	    mo2Name = mo2.getName();
	} catch (final NullPointerException np) {
	...
	final AbstractDungeonObject mo3 = app.getDungeonManager().getDungeonObject(x - 1, y + 1, z,
		DungeonConstants.LAYER_OBJECT);
	try {
	    mo3Name = mo3.getName();
	} catch (final NullPointerException np) {
	...
	final AbstractDungeonObject mo4 = app.getDungeonManager().getDungeonObject(x, y - 1, z,
		DungeonConstants.LAYER_OBJECT);
	try {
	    mo4Name = mo4.getName();
	} catch (final NullPointerException np) {
	...
	final AbstractDungeonObject mo6 = app.getDungeonManager().getDungeonObject(x, y + 1, z,
		DungeonConstants.LAYER_OBJECT);
	try {
	    mo6Name = mo6.getName();
	} catch (final NullPointerException np) {
	...
	final AbstractDungeonObject mo7 = app.getDungeonManager().getDungeonObject(x + 1, y - 1, z,
		DungeonConstants.LAYER_OBJECT);
	try {
	    mo7Name = mo7.getName();
	} catch (final NullPointerException np) {
	...
	final AbstractDungeonObject mo8 = app.getDungeonManager().getDungeonObject(x + 1, y, z,
		DungeonConstants.LAYER_OBJECT);
	try {
	    mo8Name = mo8.getName();
	} catch (final NullPointerException np) {
	...
	final AbstractDungeonObject mo9 = app.getDungeonManager().getDungeonObject(x + 1, y + 1, z,
		DungeonConstants.LAYER_OBJECT);
	try {
	    mo9Name = mo9.getName();
	} catch (final NullPointerException np) {

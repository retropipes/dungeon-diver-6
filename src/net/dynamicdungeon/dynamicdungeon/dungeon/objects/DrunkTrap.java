...
public class DrunkTrap extends AbstractTrap {
	...
	DynamicDungeon.getApplication().showMessage("You stumble around drunkenly!");
	DynamicDungeon.getApplication().getGameManager().activateEffect(DungeonEffectConstants.EFFECT_DRUNK);

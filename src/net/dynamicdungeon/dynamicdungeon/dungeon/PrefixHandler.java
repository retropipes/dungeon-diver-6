...
public class PrefixHandler implements PrefixIO {
    ...
    private static byte readFormatVersion(final DatabaseReader reader) throws IOException {
    ...
    private static void writeFormatVersion(final DatabaseWriter writer) throws IOException {

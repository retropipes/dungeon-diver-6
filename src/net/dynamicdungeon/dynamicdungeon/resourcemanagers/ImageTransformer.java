...
public class ImageTransformer {
    ...
    private static final int[] MONSTER_COLORS = new int[] { ImageTransformer.MONSTER_FIRST.getRGB(),
	    ImageTransformer.MONSTER_SECOND.getRGB(), ImageTransformer.MONSTER_OUTLINE.getRGB(),
	    ImageTransformer.MONSTER_THIRD.getRGB(), ImageTransformer.MONSTER_FOURTH.getRGB(),
	    ImageTransformer.MONSTER_FIFTH.getRGB(), ImageTransformer.MONSTER_EYE.getRGB() };
    ...
    static BufferedImageIcon templateTransformMonsterImage(final BufferedImageIcon input, final Element e,
	    final int imageSize) {

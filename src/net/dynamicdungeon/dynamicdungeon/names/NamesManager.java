...
import net.dynamicdungeon.dynamicdungeon.datamanagers.NamesDataManager;
...
public class NamesManager {
	...
	if (!NamesManager.containsKey(key)) {
	    DynamicDungeon.getErrorLogger().logError(new IllegalArgumentException("No such key " + key));
	}

...
public class NamesConstants {
    ...
    public static final String[] SECTION_ARRAY_WEAPONS = new String[] { NamesConstants.WEAPON_SPEAR,
	    NamesConstants.WEAPON_AXE, NamesConstants.WEAPON_BOW, NamesConstants.WEAPON_WHIP };
    // Faith Section Keys
    ...
    public static final int NAMES_LENGTH = NamesConstants.SECTION_ARRAY_STATS.length
	    + NamesConstants.SECTION_ARRAY_EQUIP_SLOTS.length + NamesConstants.SECTION_ARRAY_WEAPONS.length
	...
	Arrays.fill(NamesConstants.TEMP_SECTION_WEAPONS, NamesConstants.EDITOR_SECTION_WEAPONS);
	...
	System.arraycopy(NamesConstants.TEMP_SECTION_WEAPONS, 0, NamesConstants.EDITOR_SECTION_ARRAY, counter,
